...
app.controller("playerCtrl", function ($scope, $http) {
  $scope.players = [
    ...
    {
      name: "Leandro Elías Borges Silva Semedo",
      position: "Left side",
      age: "26",
    },
...
app.controller("cropsCtrl", function ($scope, $http) {
  $scope.crops = [
    {
      name: "Manuel Cadenas Montañés",
      occupation: "Coach",
      city: "Valdebimbre, Leon",
    },
    { name: "Belén Gutíerrez Santamarta", occupation: "Medical", city: "Lion" },
    {
      name: "Jorge Fernandez Cabezón",
      occupation: "Physiotherapist",
      city: "Lion",
    },
    {
      name: "Luis Puertas Castrillo",
      occupation: "Physical trainer / Assistant coach",
      city: "Lion",
    },
    {
      name: "Miguel Garcia Good",
      occupation: "Material manager",
      city: "Lion",
    },
